...
impl Format for Error {
    fn format(&self, fmt: defmt::Formatter) {
        match self {
            Self::Io(e) => Debug2Format(e).format(fmt),
            #[cfg(feature = "alloc")]
            Self::FromUtf8(e) => Debug2Format(e).format(fmt),
            #[cfg(feature = "alloc")]
            Self::Nul(e) => Debug2Format(e).format(fmt),
            ...
            Self::Underrun {
                ...
                fmt,
                "buffer underrun: read {} of {} bits",
                read_bits,
                available_bits
            ),
            Self::EncodeSkipped => "attempted to encode skipped enum variant".format(fmt),
            Self::Magic(magic) => defmt::write!(fmt, "magic mismatch. Expected: {}", magic),
            #[cfg(feature = "alloc")]
            Self::Boxed(e) => Debug2Format(e).format(fmt),
            Self::Other(e) => defmt::write!(fmt, "other: {}", Debug2Format(e)),
        }
    }
}
