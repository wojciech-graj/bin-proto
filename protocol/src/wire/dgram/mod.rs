use crate::BitRead;
use crate::{wire::middleware, Error, Parcel, Settings};
...
{
    pub fn new(middleware: M, settings: Settings) -> Self {
        Pipeline {
            middleware,
            settings,
    ...
    pub fn receive_from(&mut self, buffer: &mut dyn BitRead) -> Result<P, Error> {
